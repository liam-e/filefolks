...
import { compressPdf, type CompressResult } from "@/lib/processors/pdf";
          ...
          {savings > 0 ? (
            <>
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                <div>
                  <p className="text-emerald-600/70 text-xs mb-0.5">{t("original")}</p>
                  <p className="font-medium text-emerald-800">{formatFileSize(result.originalSize)}</p>
                </div>
                <div>
                  <p className="text-emerald-600/70 text-xs mb-0.5">{t("compressed")}</p>
                  <p className="font-medium text-emerald-800">{formatFileSize(result.compressedSize)}</p>
                </div>
                <div>
                  <p className="text-emerald-600/70 text-xs mb-0.5">{t("saved")}</p>
                  <p className="font-medium text-emerald-800">
                    {formatFileSize(savings)} ({savingsPct}%)
                  </p>
                </div>
              </div>
            </>
